...
window.OFFLINE_EVENTS = [
  ...
  {
    id: 'offline_mermaid_001', tier: 'legendary', reward: 5,
    name: '海妖低语', emoji: '🧜‍♀️',
  ...
  {
    id: 'offline_dream_001', tier: 'peaceful', reward: 0,
    name: '安静的夜晚', emoji: '💤',
    description: '鱼缸安静了一晚。小🐠们做了甜甜的梦，梦里有大海，有水草，还有你。',
    weight: 1, unlockCondition: '', enabled: true
  },
  {
    id: 'offline_moonlight_001', tier: 'peaceful', reward: 0,
    name: '月光洒落', emoji: '🌙',
...
// 等级概率分布（合计 100）
window.OFFLINE_TIER_PROBABILITY = {
  common: 50,
  rare: 25,
  epic: 10,
  legendary: 3,
