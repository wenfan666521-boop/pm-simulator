...
(function () {
  ...
  function buildHTML() {
    return [
      ...
      '</div>',
      '<div id="kleTabContent" style="flex:1;overflow-y:auto;display:flex;flex-direction:column;min-height:300px;scrollbar-width:thin;scrollbar-color:rgba(102,126,234,0.3) transparent;"></div>'
    ].join('');
  }
  ...
  function buildChatHTML() {
    return [
      '<div id="kleChatMessages" style="display:flex;flex-direction:column;height:100%;overflow-y:auto;">',
      '  <div id="kleChatMessagesInner" style="overflow-y:auto;padding:16px;display:flex;flex-direction:column;gap:4px;"></div>',
